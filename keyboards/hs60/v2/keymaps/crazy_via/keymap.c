...
[0] = LAYOUT_60_iso( /* Base */
    ...
    KC_LCTL, LT(1,KC_RGUI), KC_LALT,                                KC_SPC,                              KC_RALT, RGUI_T(KC_LEFT), LT(2,KC_DOWN), RCTL_T(KC_RGHT)),
...
[2] = LAYOUT_60_iso( /* FN 2*/
    ...
    KC_NO,   KC_NO,         KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,LCTL_T(KC_PSCR), KC_NO,       KC_NO,                 \
